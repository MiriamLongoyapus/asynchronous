//Write an asynchronous function that accepts a message string and a delay time in
// milliseconds. The function should log the message to the console after the specified
// delay time.
async function createt(message,delay){
    await new Promise(resolve=>setTimeout(resolve,delay))//wait for a promise to be solved
    console.log({createt})
}
createt("she codes",5000)



//You have an array of user IDs and a function getUserData(id) that returns a Promise with 
//user data when given a user ID. Write an asynchronous function that fetches and logs the 
